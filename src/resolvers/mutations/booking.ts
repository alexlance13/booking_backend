...
export default {
  createBooking: (obj: any, args: {booking: {apartment: string; buyer: string; dateStart: Date; dateEnd: Date}}, context: {user: IUser}): Promise<IBookingDocument> => create(args.booking, context.user),
